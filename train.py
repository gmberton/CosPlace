...
classifiers = [
    cosface_loss.MarginCosineProduct(args.fc_output_dim, len(group)) for group in groups
]
...
val_ds = TestDataset(
    args.val_set_folder, positive_dist_threshold=args.positive_dist_threshold
)
test_ds = TestDataset(
    ...
    gpu_augmentation = T.Compose(
        [
            ...
            augmentations.DeviceAgnosticRandomResizedCrop(
                [512, 512], scale=[1 - args.random_resized_crop, 1]
            ),
...
for epoch_num in range(start_epoch_num, args.epochs_num):
    ...
    dataloader = commons.InfiniteDataLoader(
